...
{
    public const string JsonSerializer = nameof(JsonSerializer);
    public const string EndpointRouting = nameof(EndpointRouting);
    public const string ControllersWithViews = nameof(ControllersWithViews);
    public const string RazorPages = nameof(RazorPages);
