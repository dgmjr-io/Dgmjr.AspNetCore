...
public static partial class LoggerExtensions
{
    ...
    public static partial void SettingUpMvcService(this ILogger logger, string serviceName, object options);

    [LoggerMessage(
        EventId = 7,
        Level = LogLevel.Information,
        Message = "Adding Mvc service to the pipeline: {ServiceName}")]
    public static partial void AddingMvcServiceToThePipeline(this ILogger logger, string serviceName);
}
