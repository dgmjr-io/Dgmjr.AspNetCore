...
//                         output.AddCssClass($"col-{this.XsSize}");
//                     break;
...
//                         output.AddCssClass($"col-sm-{this.SmSize}");
//                     break;
//                 case GridColumnRenderType.Auto:
...
//                         output.AddCssClass($"col-md-{this.MdSize}");
//                     break;
//                 case GridColumnRenderType.Auto:
...
//                         output.AddCssClass($"col-lg-{this.LgSize}");
//                     break;
//                 case GridColumnRenderType.Auto:
...
//                         output.AddCssClass($"col-xl-{this.XlSize}");
//                     break;
//                 case GridColumnRenderType.Auto:
