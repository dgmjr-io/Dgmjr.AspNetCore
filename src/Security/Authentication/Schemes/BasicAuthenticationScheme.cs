...
{
    public BasicAuthenticationScheme(string name, string? displayName, [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] type handlerType) : base(name, displayName, handlerType)
    {
    }
}
