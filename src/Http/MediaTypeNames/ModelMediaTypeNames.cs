...
public static class ModelMediaTypeNames
{
    ...
    public const string vnd_parasolid_transmit_binary = Base + "/" + "vnd_parasolid_transmit_binary";
    ...
    public const string vnd_rosette_annotated_data_model = Base + "/" + "vnd_rosette_annotated_data_model";
    ...
    public const string vnd_valve_source_compiled_map = Base + "/" + "vnd_valve_source_compiled_map";
