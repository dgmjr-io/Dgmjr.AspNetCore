...
public enum HttpRequestHeaderName
{
    ...
    /// <value>Accept</value>
    [Display(Name = "Accept", Description= "The MIME types of the response the client can understand.")]
    ...
    [Display(Name = "Accept-Encoding", Description= "The encoding algorithms the client can handle.")]
    ...
    [Display(Name = "Accept-Language", Description= "The natural languages the client can understand.")]
    [EnumMember(Value = "Accept-Language")]
    AcceptLanguage,

    /// <summary>Authentication credentials for HTTP authentication.</summary>
    /// <value>Authorization</value>
    [Display(Name = "Authorization", Description= "Authentication credentials for HTTP authentication.")]
    ...
    [Display(Name = "Cache-Control", Description= "Directives that must be obeyed by all caching mechanisms along the request/response chain.")]
    ...
    [Display(Name = "Connection", Description= "Control options for the current connection and list of hop-by-hop request fields.")]
    ...
    [Display(Name = "Content-Type", Description= "The media type of the entity-body sent to the recipient.")]
    [EnumMember(Value = "Content-Type")]
    ContentType,

    /// <summary>An HTTP cookie previously sent by the server with Set-Cookie (below).</summary>
    /// <value>Cookie</value>
    [Display(Name = "Cookie", Description= "An HTTP cookie previously sent by the server with Set-Cookie (below).")]
    ...
    /// <value>Expect</value>
    [Display(Name = "Expect", Description= "Indicates that particular server behaviors are required by the client.")]
    ...
    /// <value>Host</value>
    [Display(Name = "Host", Description= "The domain name of the server (for virtual hosting), and the TCP port number on which the server is listening.")]
    ...
    [Display(Name = "If-Match", Description= "Only perform the action if the client supplied entity matches the same entity on the server.")]
    ...
    [Display(Name = "If-Modified-Since", Description= "Allows a 304 Not Modified to be returned if content is unchanged.")]
    [EnumMember(Value = "If-Modified-Since")]
    IfModifiedSince,

    /// <summary>Allows a 304 Not Modified to be returned if content is unchanged.</summary>
    /// <value>If-None-Match</value>
    [Display(Name = "If-None-Match", Description= "Allows a 304 Not Modified to be returned if content is unchanged.")]
    ...
    [Display(Name = "If-Range", Description= "If the entity is unchanged, send me the part(s) that I am missing; otherwise, send me the entire new entity.")]
    ...
    [Display(Name = "If-Unmodified-Since", Description= "Only send the response if the entity has not been modified since a specific time.")]
    ...
    [Display(Name = "Max-Forwards", Description= "Limit the number of times the message can be forwarded through proxies or gateways.")]
    ...
    /// <value>Pragma</value>
    [Display(Name = "Pragma", Description= "Implementation-specific headers that may have various effects anywhere along the request-response chain.")]
    ...
    [Display(Name = "Proxy-Authorization", Description= "Authorization credentials for connecting to a proxy.")]
    [EnumMember(Value = "Proxy-Authorization")]
    ProxyAuthorization,

    /// <summary>Request only part of an entity.  Bytes are numbered from 0.</summary>
    /// <value>Range</value>
    [Display(Name = "Range", Description= "Request only part of an entity.  Bytes are numbered from 0.")]
