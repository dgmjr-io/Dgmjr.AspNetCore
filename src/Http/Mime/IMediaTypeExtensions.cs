...
public static class IMediaTypeExtensions
{
    ...
    /// </summary>
    /// <param name="_this">The media type beind compared to <paramref name="other" /></param>
    ...
    public static bool Matches(this IMediaType _this, string other) =>
        _this.Matches(new TempMediaType(other));
